...
import com.example.astuteresolution.env.BorderedText;
import com.example.astuteresolution.env.FileUtils;
import com.example.astuteresolution.env.ImageUtils;
import com.example.astuteresolution.env.Logger;
import com.example.astuteresolution.ml.BlazeFace;
import com.example.astuteresolution.tracking.MultiBoxTracker;
...
public class Main5Activity extends CameraActivity implements OnImageAvailableListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        AlertDialog editDialog = new AlertDialog.Builder(Main5Activity.this)
