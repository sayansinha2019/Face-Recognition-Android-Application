...
extern "C" void Java_com_example_astuteresolution_ml_LibSVM_jniSvmScale(JNIEnv *env, jobject obj, jstring cmdIn,
...
extern "C" void Java_com_example_astuteresolution_ml_LibSVM_jniSvmTrain(JNIEnv *env, jobject obj, jstring cmdIn) {
    const char *cmd = env->GetStringUTFChars(cmdIn, 0);
...
extern "C" void
Java_com_example_astuteresolution_ml_LibSVM_jniSvmPredict(JNIEnv *env, jobject obj, jstring cmdIn, jobject buf,
                                               jint len) {
    const char *cmd = env->GetStringUTFChars(cmdIn, 0);
...
extern "C" void Java_com_example_astuteresolution_ml_LibSVM_testLog(JNIEnv *env, jobject obj, jstring logThis) {
